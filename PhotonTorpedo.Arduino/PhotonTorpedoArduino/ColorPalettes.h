...
#ifdef INCLUDE_XMAS_DEMO
    {
        {"Weihnachten 1", {CRGB::Black, CRGB::DarkViolet, CRGB::DarkRed, CRGB::Black, CRGB::DarkCyan, CRGB::DarkBlue, CRGB::Black, CRGB::DarkOrange, CRGB::DarkGreen}},
        {"Weihnachten 2", {CRGB::Black, CRGB::DarkRed, CRGB::Gray, CRGB::DarkRed, CRGB::DarkGreen, CRGB::Gray, CRGB::DarkGreen}},
        {"Poppig", {CRGB(0xAAFF00), CRGB(0xFFAA00), CRGB(0xFF00AA), CRGB(0xAA00FF), CRGB(0x00AAFF)}},
